...
const FAQ = () => {
  return (
    <section className="pb-40 1xl:pb-55">
      <div className="section flex flex-col pt-8.75 pb-7.5 1xl:flex-row 1xl:justify-between 1xl:items-start 1xl:gap-24 4xl:gap-55">
        ...
        {/*Right: list */}
        <ul className="flex flex-col w-full gap-21 1xl:gap-14.5 mb-25 1xl:mb-19 3xl:mb-10 4xl:mb-20 1xl:max-w-[902px] 3xl:max-w-[1156px] 4xl:max-w-[1488px]">
