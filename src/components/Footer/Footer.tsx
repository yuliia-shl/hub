...
const Footer = () => {
  return (
    <footer className="w-full pb-[7px] 1xl:pb-14.5 4xl:pb-17">
      <div className="section pb-17 1xl:pb-19.5 4xl:pb-6.5">
        <div className="flex flex-row justify-between 1xl:justify-none mb-15 1xl:mb-0">
          <div className="flex flex-row items-start gap-x-[6px] 1xl:gap-x-2.5 4xl:gap-x-3 1xl:mb-8 4xl:mb-15">
          ...
          <div className="flex gap-x-4 1xl:gap-x-5 3xl:pt-4 4xl:gap-x-14 1xl:w-1/2 1xl:mb-22 4xl:mb-20">
            <a
              href="#"
              target="_blank"
        ...
        <div className="flex flex-col 1xl:flex-row">
          <div className="flex flex-col 1xl:order-2 1xl:self-end 1xl:w-1/2">
            ...
            <div className="flex flex-row mb-15 4xl:mb-0">
          ...
          <div className="flex flex-col 1xl:w-1/2 4xl:flex-row">
            ...
            <div className="flex flex-col gap-6 1xl:mr-24.5 1xl:max-w-[280px]">
