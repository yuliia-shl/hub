...
export default function SmartButton({
  ...
  const baseClasses =
    'font-semibold py-2 px-4 rounded-full border-star-dust-400 text-star-dust-400 hover:text-tangerine hover:border-tangerine transition-colors border-1 inline-flex items-center justify-center focus:outline-tangerine focus:outline-2 focus:text-tangerine py-4 4xl:py-[21px] px-6 4xl:px-6 rounded-full duration-300 w-fit';

  const variantClasses = {
    primary: 'bg-woodsmoke-dimmed',
